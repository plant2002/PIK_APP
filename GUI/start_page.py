...
class StartGUI:
    def __init__(self, master, show_frame):
        ...
        self.canvas = DragDrop(self.frame, bg="#FFFFFF", height=682, width=1024, bd=0, highlightthickness=0, relief="ridge")
        ...
        self.button_2 = Button(self.canvas, image=self.startbutton_image_2, borderwidth=0, highlightthickness=0, command=lambda: show_frame("reimport"), relief="flat")
        self.canvas.create_window(657.5, 214.5, anchor="nw", window=self.button_2)
        self.button_3 = Button(self.canvas, image=self.startbutton_image_3, borderwidth=0, highlightthickness=0, command=lambda: print("button_3 clicked"), relief="flat")
        self.canvas.create_window(657.5, 299.0, anchor="nw", window=self.button_3)
        ...
        self.canvas.create_text( 110.5, 149.5, anchor="nw", text="drag here to import\n", fill="#000000", font=("InriaSans Regular", 15 * -1))
    ...
    def handle_files_dropped(self):
        folder_path = os.path.join(ROOT_DIR, "files")
