...
def failcheck(fn, code, mycursor):
    sql_fcheck = "SELECT COUNT(*) FROM faildata WHERE code = %s AND FN = %s"
...
def move_read_files(file_name):
    source_folder = r"C:\Users\milas\Desktop\PIK_APP\uploads"
    destination_folder = r"C:\Users\milas\Desktop\PIK_APP\processed"
